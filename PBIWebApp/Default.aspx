...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- Sign in -->
    <div>
        <h1 style="border-bottom: solid; border-bottom-color: silver">Power BI: Integrate report sample web applicaton</h1>
    ...
    <div>
        <asp:Panel ID="PanelReports" runat="server" Visible="true">
            ...
            <table>
                ...
                <tr>
                    <td>
                        <asp:Button ID="Button2" runat="server" OnClick="getReportsButton_Click" Text="Get Reports" /></td>
                </tr>
                <tr>
                    <td>
                        <asp:TextBox ID="tb_reportsResult" runat="server" Height="200px" Width="1024px" TextMode="MultiLine" Wrap="False"></asp:TextBox></td>
                </tr>
    ...
    <div>
        <asp:Panel ID="PanelEmbed" runat="server" Visible="true">
            ...
            <table>
                <tr>
                    <td>Enter an embed url for a report from Step 2 (starts with https://):<br />
                ...
                <tr>
                    <td>
                        <input type="text" id="txbCode" value="AL" />
                    </td>
                </tr>
                <tr>
                    <td>
