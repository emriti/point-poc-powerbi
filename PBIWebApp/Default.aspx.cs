    ...
    public partial class _Default : Page
    {
        ...
        protected void signInButton_Click(object sender, EventArgs e)
        {
            ...
            var @params = new NameValueCollection
            {
                ...
                {"redirect_uri", "http://pointpoc.azurewebsites.net/Redirect"}
            };
        ...
        protected void getReportsButton_Click(object sender, EventArgs e)
        {
            ...
            System.Net.WebRequest request = System.Net.WebRequest.Create(String.Format("{0}groups/98bb1c0b-3408-42b1-abca-20440b9a7d35/reports", baseUri)) as System.Net.HttpWebRequest;
            ...
            using (var response = request.GetResponse() as System.Net.HttpWebResponse)
            {
                ...
                using (var reader = new System.IO.StreamReader(response.GetResponseStream()))
                {
                    ...
                    {
                        tb_reportsResult.Text += String.Format("{0}\t{1}\t{2}{3}\n", rpt.id, rpt.name, rpt.embedUrl, "&filterPaneEnabled=false");
                    }
                }
            }
        }
